...
double HPoint3d::DotProduct(const HPoint3d& p) const
{
	return mx * p.mx + my * p.my + mz * p.mz;
}

double HPoint3d::Length() const
{
...
HPoint3d operator /(const HPoint3d& pt, double d)
{
	return pt * (1 / d);
}
...
double HPoint2d::DotProduct(const HPoint2d& p) const
{
	return mx * p.mx + my * p.my;
}

double HPoint2d::Length() const
{
...
HPoint2d operator *(const HPoint2d& pt, double d)
{
	return HPoint2d{ pt.x() * d, pt.y() * d,1};
}
